      ...
      <div className="message-box">
        ...
        <div className="buttons-con">
          <div className="action-link-wrap">
            <a href='/' className="link-button link-back-button">Go to Home</a>
            {/* <a className="link-button">Go to Home Page</a> */}
            <a className="link-button link-back-button" href="http://www.bcl-st.com.br" target="_blank" rel="noopener noreferrer">Help Go to BCL-ST</a>
          </div>
        </div>
      </div>
    </section>
